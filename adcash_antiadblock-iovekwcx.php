...
class AdcashAntiAdblock_iovekwcx
{
    const ADCASH_ZONE_ID = 'iovekwcx';
    const ADCASH_ZONE_TYPE = 'atag';
    const ADCASH_SERVER_DOMAIN = 'onclickperformance.com';
    const ADCASH_FALLBACK_DOMAIN = 'ashcdn.com';
...
$adblock = new AdcashAntiAdblock_iovekwcx();
echo $adblock->run();